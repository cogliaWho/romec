<div class="content">
	...
	<div class="container-half no-pad b-bottom chisiamo-header">
		<!-- <img class="full-img" src="resources/images/slide_3.jpg"> -->
	</div>
	<div class="container-half">
		...
		<div class="vert-third img-list">
			<a href="<?php echo site_url('resources/docs/articolo_valcamonica.pdf'); ?>" target="_blank">
				<img class="full-img" alt="" src="<?php echo site_url('resources/docs/thumb/articolo_valcamonica.png'); ?>">
			</a>
		</div>
		<div class="vert-third img-list">
		...
		<div class="vert-third img-list">
			<a href="<?php echo site_url('resources/docs/certif_sicurezza.pdf'); ?>" target="_blank">
