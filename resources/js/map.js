function initMap(){
    ...
    var isWheelScrollable = true;

    if(isMobile){
      isDraggable = false;
      isWheelScrollable = false;
    }
    ...
    var image = 'resources/images/logo.png';
    ...
    var contentString = '<div style="text-align: center;"><img width="40%" src="resources/images/logo.png"/><p class="txt-c" style="font-size:.9rem;">ROMEC snc di Romele e Giacomo e C.</p></div>';
