...
class Slideshows_model extends CI_Model {
	...
	{      
        ...
        $query = $this->db->get('romec_slideshows');
	...
	public function set_slideshow()
	{
    	...
    	return $this->db->insert('romec_slideshows', $data);    
	}
    ...
    public function get_slides($slideshow = FALSE)
	{
        if ($slideshow === FALSE)
        {
            $query = $this->db->get('romec_slides');
            return $query->result_array();
            die();
        }
        
        $query = $this->db->get_where('romec_slides', array('slideshow' => $slideshow));
        return $query->result_array();
	}

	public function remove_slide($slideID){
		return $this->db->delete('romec_slides', array('id' => $slideID));
	}
	...
	public function set_slide()
	{
	    ...
	    return $this->db->insert('romec_slides', $data);
	}
}